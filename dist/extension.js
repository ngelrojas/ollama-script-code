...
class OllamaViewProvider {
    ...
    resolveWebviewView(webviewView, _context, _token) {
        ...
        webviewView.onDidDispose(() => {
            /* eslint-disable */ console.log(...oo_oo(`235860073_22_6_22_37_4`, "Webview disposed"));
        });
        webviewView.webview.onDidReceiveMessage(async (message) => {
            /* eslint-disable */ console.log(...oo_oo(`235860073_27_10_27_58_4`, "Received message", message.command));
            switch (message.command) {
                case 'send':
                    const config = vscode.workspace.getConfiguration("ollama-script-code");
                ...
                case 'saving':
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`235860073_62_14_62_45_4`, "saving", dataSave));

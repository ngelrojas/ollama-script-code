                  ...
                  if (olDBList.length === 0) {
                      ...
                      olDBList.forEach(item => {
                          ...
                          btnDel.addEventListener('click', function(){
                            ...
                            console.log('DELETED ', idDelHistory);

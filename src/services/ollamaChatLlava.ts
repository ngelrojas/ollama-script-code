...
let conversationHistory: RequestMessage[] = [];
...
export const OllamaChatLLava = async (inputMsg: any, clearHistory: boolean = false) => {
  if (clearHistory) {
    conversationHistory = [];
    return "";
  }
  ...
  let historyConversation: RequestMessage = {
    role: OLLAMA_ROLES.USER,
    content: contentQuestion,
    images: [inputMsg.question.img],
  };

  conversationHistory.push(historyConversation);
